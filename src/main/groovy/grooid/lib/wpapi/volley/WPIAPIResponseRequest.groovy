 ...
 */
@CompileStatic
public class WPIAPIResponseRequest extends Request<WPIAPIResponse> {
     ...
     */
    public WPIAPIResponseRequest(int method, String url, Listener<WPIAPIResponse> listener,  ErrorListener errorListener) {
    ...
    protected Response<WPIAPIResponse> parseNetworkResponse(NetworkResponse response) {
        ...
        return Response.success(new WPIAPIResponse(total: total, totalPages: totalPages, path: path, objectNotation: parsed), HttpHeaderParser.parseCacheHeaders(response));
    }
}
